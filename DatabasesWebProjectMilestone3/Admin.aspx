...
<body>
 ...
 during the last year along with the total amount of earned points, press this button. The results will be shown next to their respective labels below!" ID="accepted_payment_transactions_for_account_label"></asp:Label>
            ...
            <br />
            <br />
            <asp:Label runat="server" Text="Number of accepted payment transactions: " ID = "account_accepted_payments_number"></asp:Label>
            <br />
        ...
        <div class="">
            ...
            <br />
            <br />
            <asp:Button runat="server" Text="View Data" OnClick="wallet_cashback_amount"></asp:Button>&nbsp;</div>
            <br />
 ...
 a certain duration, please input the required wallet ID along with the start and end dates of the duration, then press this button. The result will be shown in a table below!" ID="Label14"></asp:Label>
            ...
            <br />
            <br />
            <asp:Button runat="server" Text="View Data" OnClick="wallet_transfer_amount"></asp:Button>&nbsp;</div>
            <br />
        ...
        <div class="">
            ...
            <br />
            <br />
            <asp:Button runat="server" Text="View Data" OnClick="Wallet_MobileNo"></asp:Button>&nbsp;</div>
            <br />
